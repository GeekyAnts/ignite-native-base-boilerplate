...
describe("generators", () => {
	...
	test("generate listview of type row works", async () => {
		await execa(IGNITE, ["g", "list", "TestRow", "--type=Row", "--codeType=listview", "--dataType=Single"], {
			preferLocal: false,
		});
	...
	test("generate flatlist of type row works", async () => {
		await execa(IGNITE, ["g", "list", "TestFlatRow", "--type=Row", "--codeType=flatlist", "--dataType=Single"], {
			preferLocal: false,
		});
	...
	test("generate listview of sections works", async () => {
		await execa(IGNITE, ["g", "list", "TestSection", "--type=Row", "--codeType=listview", "--dataType=Sectioned"], {
			preferLocal: false,
		});
	...
	test("generate listview of type grid works", async () => {
		await execa(IGNITE, ["g", "list", "TestGrid", "--type=Grid", "--codeType=listview", "--dataType=Single"], {
			preferLocal: false,
		});
